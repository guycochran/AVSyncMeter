...
final class WalkAndClockTests: XCTestCase {
    ...
    func testReplicaPulseDoesNotStealNextFlash() {
        ...
        _ = e.ingestFlash(VisualFlashEvent(timestampSeconds: 3.0, luminance: 0.8, threshold: 0.1))
        _ = e.ingestPulse(AudioPulseEvent(timestampSeconds: 3.006, envelope: 0.4, threshold: 0.1))
        let snap = e.snapshot()
